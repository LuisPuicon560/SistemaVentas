...
session_start();
    ...
    if( isset($_REQUEST['busqueda']) && $_REQUEST['busqueda'] == '' ){
        header("location:listar_egreso_variable.php");
    }
...
<body>
	...
	<section id="container">
		...
		<h1><i class="far fa-newspaper"></i> Lista de Egresos de Costo Variable</h1>
        ...
        <form action="buscar_variable.php" method="get" class="form_search">
            ...
            <a href="listar_egreso_variable.php" class="btn_cl"> X</a>
        ...
        <table class="table table-light">
            <tbody>
                ...
                <?php
                //PAGINADOR
                $sql_register = mysqli_query($conexion,"SELECT COUNT(*) AS total_registro FROM egreso_variable WHERE $where ");
                ...
                //LISTAR REGISTROS
                    ...
                    $query = mysqli_query($conexion,"SELECT id_variable, gastos, descripcion, total, fecha FROM egreso_variable
                                                    WHERE $where AND estado != 10 ORDER BY fecha DESC LIMIT $desde,$por_pagina");
